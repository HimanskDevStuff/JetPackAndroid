    ...
    override fun onClick(v: View?) {
        when(v?.id){
            R.id.send_money_btn -> {
                ...
                //Or we can use the generated class which is generated by safe args plugin
                //Comment out this line to try this one too
                //navController.navigate(MainFragmentDirections.actionMainFragmentToChooseRecipientFragment())
            }
            R.id.view_transactions_btn -> navController.navigate(R.id.action_mainFragment_to_viewTransactionFragment3)
